 ...
 */
@Service
public class PayResultBaseConsumer extends BaseConsumer implements ApplicationListener<ContextRefreshedEvent> {

    private static final Logger log = LoggerFactory.getLogger(PayResultBaseConsumer.class);
